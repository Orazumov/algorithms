...
# далее начинаем сравнивать весь массив со следующей цифрой, ищем есть ли меньше нее и т.д.
...
# массив как книжная полка. если в массиве 1 элемент, то он упорядочек.
